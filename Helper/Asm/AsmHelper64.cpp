...
namespace IronMan
{
	...
	void AsmHelper64::GenPrologue(bool switchMode /*= false*/)
	{
		...
		else
		{
			...
			_assembler.mov(asmjit::host::qword_ptr(asmjit::host::rsp, 5 * sizeof(uint64_t)), asmjit::host::r15);
		}
	}
	...
	void AsmHelper64::GenEpilogue(bool switchMode /*= false*/, int /*retSize = 0*/)
	{
		...
		else
		{
			...
			_assembler.mov(asmjit::host::r15, asmjit::host::qword_ptr(asmjit::host::rsp, 5 * sizeof(uint64_t)));
		}
