...
PUBLIC	?base@@3_KA					; base
PUBLIC	?image_size@@3_KA				; image_size
PUBLIC	?MainThread@@3PEAXEA				; MainThread
...
_BSS	SEGMENT
?base@@3_KA DQ	01H DUP (?)				; base
?MainThread@@3PEAXEA DQ 01H DUP (?)			; MainThread
_BSS	ENDS
...
CONST	ENDS
_DATA	SEGMENT
?image_size@@3_KA DQ 0000000000001000H			; image_size
_DATA	ENDS
CONST	SEGMENT
...
PUBLIC	?Bootstarp@@YAKPEAX@Z				; Bootstarp
PUBLIC	DllMain
...
EXTRN	?Attach@Console@IronMan@@YAXXZ:PROC		; IronMan::Console::Attach
EXTRN	__imp_WSAStartup:PROC
EXTRN	__imp_WSACleanup:PROC
EXTRN	OPENSSL_init_ssl:PROC
EXTRN	?Initialize@Core@IronMan@@YA_N_K@Z:PROC		; IronMan::Core::Initialize
...
pdata	ENDS
pdata	SEGMENT
$pdata$?Bootstarp@@YAKPEAX@Z DD imagerel $LN3
	DD	imagerel $LN3+31
	DD	imagerel $unwind$?Bootstarp@@YAKPEAX@Z
$pdata$DllMain DD imagerel $LN9
	DD	imagerel $LN9+91
...
$unwind$WinMain DD 011801H
	DD	04218H
$unwind$?Bootstarp@@YAKPEAX@Z DD 010901H
	DD	04209H
...
; 28   : 	switch (dwReason)
	...
	mov	eax, DWORD PTR dwReason$[rsp]
...
; 31   : 		MainThread = CreateThread(0, 0, &Bootstarp, hInstance, 0, 0);

	mov	QWORD PTR [rsp+40], 0
	mov	DWORD PTR [rsp+32], 0
	mov	r9, QWORD PTR hInstance$[rsp]
	lea	r8, OFFSET FLAT:?Bootstarp@@YAKPEAX@Z	; Bootstarp
	xor	edx, edx
	xor	ecx, ecx
	call	QWORD PTR __imp_CreateThread
	mov	QWORD PTR ?MainThread@@3PEAXEA, rax	; MainThread
$LN2@DllMain:
...
_TEXT	SEGMENT
lpParam$ = 48
?Bootstarp@@YAKPEAX@Z PROC				; Bootstarp
...
; 21   : 	Console::Attach();
	...
	call	?Attach@Console@IronMan@@YAXXZ		; IronMan::Console::Attach

; 22   : 	Core::Initialize((ptr_t)lpParam);

	mov	rcx, QWORD PTR lpParam$[rsp]
	call	?Initialize@Core@IronMan@@YA_N_K@Z	; IronMan::Core::Initialize
...
; 24   : }
	...
	add	rsp, 40					; 00000028H
	ret	0
?Bootstarp@@YAKPEAX@Z ENDP				; Bootstarp
_TEXT	ENDS
; Function compile flags: /Odtp
...
; 48   : 	return Bootstarp(NULL);

	xor	ecx, ecx
	call	?Bootstarp@@YAKPEAX@Z			; Bootstarp
